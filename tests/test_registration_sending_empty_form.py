...
@ddt
class RegistrationTestEmptyForm(BaseTest):
    """
    Testy strony Rejestracja
    """
    @data(*get_data("empty_form.csv"))
    @unpack
    def test_empty_form(self, email, name, phone, zipcode, password, repeat_password, paczkomat, error):
        """Test rejestracji nowego użytkownika - pusty formularz"""
