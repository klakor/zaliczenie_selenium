...
@ddt
class RegistrationTestName(BaseTest):
    """
    Testy strony Rejestracja
    """
    @data(*get_data("incorrect_names.csv"))
    @unpack
    def test_registration_incorrect_names(self, email, name, phone, zipcode, password, repeat_password, paczkomat, error):
        """Test rejestracji nowego użytkownika - nieprawidłowe imię"""
